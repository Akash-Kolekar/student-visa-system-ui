            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">Student Visa System</span>{' '}
                  <span className="block text-indigo-600 xl:inline">on Blockchain</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  A secure, transparent, and efficient system for processing student visa applications 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              A better way to process visa applications
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our blockchain-based system provides enhanced security, transparency, and efficiency.
            </p>
          </div>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              <div className="flex flex-col items-center">
                ...
                <div className="mt-5 text-center">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Secure & Immutable</h3>
                  <p className="mt-2 text-base text-gray-500">
                    All application data is securely stored on the blockchain, preventing fraud and tampering.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="mt-5 text-center">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Automated verification and smart timeline management ensure faster processing times.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="mt-5 text-center">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Track your application status in real-time with complete transparency at every step.
                  </p>
                </div>
              </div>
            </div>
